...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.signup = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var hashedPassword, user, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.hash(data.password, 10)];
                        case 1:
                            hashedPassword = _a.sent();
                            return [4 /*yield*/, this.prisma.user.create({
                                    data: __assign(__assign({}, data), { passwordHash: hashedPassword }),
                                })];
                        case 2:
                            user = _a.sent();
                            token = this.jwtService.sign({ id: user.id });
                            return [2 /*return*/, { user: __assign(__assign({}, user), { passwordHash: undefined }), token: token }];
                    }
                });
            });
        };
